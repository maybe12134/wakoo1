...
return [
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => 't3ja7z2UVCi9mRNHoTyWYMB08fsSIAEQ',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
    ...
    'qiniu' => [
        ...
        "domain" => 'cdn.wakoohome.top/',
        "bucket" => 'wkimage123',
        "accessKey" => 'qEcvaGP-gpW6BypGf0w75uEgbZgwpQMcbJxyDU75',
        "secretKey" => 'LKK0Sl38yKWV3hjc2vZ6nkoxGIqpiI-LL36uEMox',
    ],
];
